...
sub EVENT_SIGNAL {
    if ($signal == 99597) {
        quest::settimer(99597, 0.02);
    } elsif ($signal == 99598) {
        quest::settimer(99598, 0.02);
    } elsif ($signal == 99599) {
        quest::settimer(99599, 0.02);
    }
}
